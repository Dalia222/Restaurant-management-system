...
public class Order {
    ...
    public String ordering(Order o1, Menu m1, Customer c1, String itemID, String branchname) {
        ...
        if (itemsSection == 'A') {
            o1.addItem(m1.Menues.get(branchname).getAppetizer(num - 1));
        } else if (itemsSection == 'M') {
            o1.addItem(m1.Menues.get(branchname).getMainDish(num - 1));
        } else if (itemsSection == 'D') {
            o1.addItem(m1.Menues.get(branchname).geDrink(num - 1));
        }
