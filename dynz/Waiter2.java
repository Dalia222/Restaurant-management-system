...
public class Waiter2 extends Scene {
    ...
    public Waiter2(StackPane parent, double d, double d1, Branches branch1, Tables t1, Customer c1, Manager m1, Owner owner1, Waiter waiter1, Menu menu1, Item item1, Order order1, Register Register1) throws FileNotFoundException {
        ...
        Image logo = new Image(new FileInputStream("C:\\Users\\dell\\Desktop\\SignUp.png"));
        ImageView logoview = new ImageView(logo);
        Image Background = new Image(new FileInputStream("C:\\Users\\dell\\Desktop\\SignUp.png"));
        ImageView Backgroundview = new ImageView(Background);
        Image backimage = new Image(new FileInputStream("C:\\Users\\dell\\Desktop\\SignUp.png"));
        ...
        Login.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (username.getText().equals("") || pass.getText().equals("")) {
                    ...
                    try {
                        DYNZ.myStage.setScene(new WaiterMenu(new StackPane(), 1000, 600, branch1, t1, c1, m1, owner1, waiter1, menu1, item1, order1, Register1));
        ...
        Back.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                DYNZ.myStage.setScene(new Welcome(new StackPane(), 1000, 600, branch1, t1, c1, m1, owner1, waiter1, menu1, item1, order1, Register1));
        ...
        scene2all.getStylesheets().add("/dynz/WelcomeStyle.css");
        setRoot(scene2all);
    }
