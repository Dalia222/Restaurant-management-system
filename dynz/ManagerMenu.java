...
public class ManagerMenu extends Scene {
    ...
    public ManagerMenu(Parent parent, double d, double d1, Branches branch1, Tables t1, Customer c1, Manager m1, Owner owner1, Waiter waiter1, Menu menu1, Item item1, Order order1, Register Register1) {
        super(parent, d, d1);
        Pane pane1 = new Pane();
        ImageView background2 = new ImageView("C:\\Users\\dell\\Desktop\\abstract-blur-coffee-shop-cafe-interior.png");
        ...
        exit.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                DYNZ.myStage.setScene(new Manager2(new StackPane(), 1000, 600, branch1, t1, c1, m1, owner1, waiter1, menu1, item1, order1, Register1));
            }
        });
        ...
        Go.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (str.equals("Add Waiter")) {
                    DYNZ.myStage.setScene(new WaiterSignUp(new StackPane(), 1000, 600, branch1, t1, c1, m1, owner1, waiter1, menu1, item1, order1, Register1));
                    ...
                    DYNZ.myStage.setScene(new MenuAdd(new StackPane(), 1000, 600, branch1, t1, c1, m1, owner1, waiter1, menu1, item1, order1, Register1));
        ...
        pane1.getChildren().addAll(
                background2,
                b1, exit, Go);
        pane1.getStylesheets().add("/dynz/WelcomeStyle.css");
