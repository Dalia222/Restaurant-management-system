...
public class Manager2 extends Scene {
    ...
    public Manager2(StackPane parent, double d, double d1,Branches b1,Tables t1,Customer c1,Manager m1,Owner owner1,Waiter waiter1,Menu menu1,Item item1,Order order1,Register Register1) {
        ...
        Back.setOnAction(new EventHandler<ActionEvent>() {  
            ...
            DYNZ.myStage.setScene(new Welcome(new Label(), 1000, 600,b1,t1,c1,m1,owner1,waiter1,menu1,item1,order1,Register1));
        }
        });
            ...
            public void handle(ActionEvent event) {
                ...
                DYNZ.myStage.setScene(new ManagerMenu(new Label(), 1000, 600,b1,t1,c1,m1,owner1,waiter1,menu1,item1,order1,Register1)); 
                pf.clear();
                unf.clear();
            }
                else {
