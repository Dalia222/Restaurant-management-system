...
public class Login extends Scene{
   public Login(Pane parent, double d, double d1,Branches branch1,Tables t1,Customer c1,Manager m1,Owner owner1,Waiter waiter1,Menu menu1,Item item1,Order order1,Register Register1) {
        super(parent, d, d1);
        ImageView background3 = new ImageView("C:\\Users\\dell\\Desktop\\Sign In.png");
        ...
        btnLogin.setOnAction(new EventHandler<ActionEvent>() {  
            ...
            public void handle(ActionEvent event) {
                ...
                DYNZ.myStage.setScene(new CustomerFunctions(new Label(), 1000, 600,branch1,t1,c1,m1,owner1,waiter1,menu1,item1,order1,Register1)); 
                pf.clear();
                txtUserName.clear();
            }
                else {
        ...
        signUp.setOnAction(new EventHandler<ActionEvent>() {  
            ...
            public void handle(ActionEvent event) {
            DYNZ.myStage.setScene(new SignUp(new Pane(), 1000, 600,branch1,t1,c1,m1,owner1,waiter1,menu1,item1,order1,Register1));
            }
        });
        ...
        parent.getStylesheets().add("/dynz/WelcomeStyle.css");
        setRoot(parent);
    } 
}