    ...
    public WaiterMenu(StackPane parent, double d, double d1, Branches branch1, Tables t1, Customer c1, Manager m1, Owner owner1, Waiter waiter1, Menu menu1, Item item1, Order order1, Register Register1) throws FileNotFoundException {
        ...
        Back2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    DYNZ.myStage.setScene(new Waiter2(new StackPane(), 1100, 600, branch1, t1, c1, m1, owner1, waiter1, menu1, item1, order1, Register1));
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(WaiterMenu.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
        Image logo = new Image(new FileInputStream("C:\\Users\\dell\\Desktop\\tabletop-looking-out-empty-restaurant.png"));
        ImageView logoview = new ImageView(logo);
        Image Background = new Image(new FileInputStream("C:\\Users\\dell\\Desktop\\tabletop-looking-out-empty-restaurant.png"));
        ImageView Backgroundview2 = new ImageView(Background);
        Image backimage = new Image(new FileInputStream("C:\\Users\\dell\\Desktop\\tabletop-looking-out-empty-restaurant.png"));
        ...
        Addorder.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                DYNZ.myStage.setScene(new WaiterOrdering(new Pane(), 1000, 600, branch1, t1, c1, m1, owner1, waiter1, menu1, item1, order1, Register1));
            }
        });
        ...
        Image waiterphoto = new Image(new FileInputStream("C:\\Users\\dell\\Desktop\\tabletop-looking-out-empty-restaurant.png"));
        ...
        waiterall.getChildren().addAll(
                Backgroundview2,
                welcomew);
        waiterall.getStylesheets().add("/dynz/WelcomeStyle.css");
        setRoot(waiterall);
    }
}
