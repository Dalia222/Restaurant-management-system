...
public class ManagerSignUp extends Scene implements Serializable {
    ...
    public ManagerSignUp(Parent parent, double d, double d1, Branches branch1, Tables t1, Customer c1, Manager m1, Owner owner1, Waiter waiter1, Menu menu1, Item item1, Order order1, Register Register1) {
        ...
        ImageView background2 = new ImageView("C:\\Users\\dell\\Desktop\\Backmanager.jpg");
...
// Adding Back Button
        ...
        back.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                DYNZ.myStage.setScene(new OwnerFunctions(new Pane(), 1000, 600, branch1, t1, c1, m1, owner1, waiter1, menu1, item1, order1, Register1));
            }
        });
        ...
        addBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (owner1.ADDMANAGER(m1, firstNameTextField.getText(), lastNameField.getText(), Phonenumber.getText(), Branchname.getValue(), usernameField.getText(), pwBox.getText(), pwreBox.getText()).equals("done")) {
                    ...
                    m1.Managers.put(usernameField.getText(), newm);
                    try {
                        try ( ObjectOutputStream o = new ObjectOutputStream(new FileOutputStream("Managersbin.bin"))) {
                            o.writeObject(m1.Managers);
                            //i don't read it
                        }
                    } catch (IOException e) {
                        System.out.println(e);
                    }
                    System.out.println(m1.Managers);
